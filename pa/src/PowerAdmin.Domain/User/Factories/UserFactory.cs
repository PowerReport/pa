...
public class UserFactory : IUserFactory {
  ...
  public async Task<(UserIdentity, string)>
  CreateUser(UserName userName, Password password, Password confirmPassword,
    ...
    var user = new UserIdentity { UserName = userName,
