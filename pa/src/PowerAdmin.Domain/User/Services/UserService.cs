...
public class UserService : IUserService {
  ...
  public async Task<UserIdentity> Create(UserName userName, Password password,
                                         Password confirmPassword,
                                         PhoneNumber phoneNumber, Email email,
                                         bool twoFactorEnabled = false) {
    var (user, userPassword) =
        await userFactory.CreateUser(userName, password, confirmPassword,
                                     phoneNumber, email, twoFactorEnabled);
